Create one horizontal animation strip for Codex pet `patch`, state `failed`.
...
Identity: same pet in every frame: Tiny compact cyberpunk raccoon PR reviewer; charcoal-gray fur, bold raccoon mask and striped tail, cyan and warm-magenta tech accents, one small opaque wrist-mounted review terminal integrated into the left forearm, alert friendly expression, no readable text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Polished miniature collectible-toy style, rounded readable silhouette, restrained neon accents, crisp opaque materials, designed for a 192x208 sprite cell..
